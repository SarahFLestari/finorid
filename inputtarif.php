...
<head>
	...
	<nav class="row container-fluid">
		...
		<div class="row col-lg-4 col-md-offset-4 kotakan ">
				<form action="inputSQLTarif.php" method="POST">
					<div class="form-group">
						<label>ID Jasa</label>
						<input type="text" class="form-control" placeholder="Masukkan ID Jasa" required="true" name="idjasa" id="idjasa">
					</div>
					<div class="form-group">
						<label>Nama Jasa</label>
						<input type="text" class="form-control" placeholder="Masukkan Nama Jasa" required="true" name="namajasa" id="namajasa">
					</div>
					<div class="form-group">
						<label>Tarif</label>
						<input type="number" min="1000" class="form-control" placeholder="Masukkan Tarif" required="true" name="tarif" id="tarif">
					</div>
					<div>
						<button type="submit" id="kirim" name="kirim" class="btn btn-info">Kirim</button>
					</div>
				</form>
		</div>
	</nav>
